...
import pfdToText from "react-pdftotext";
...
const Dashboard = () => {
  ...
  const uploadResume = async (event) => {
    ...
    setIsLoading(true)
    try {
      const resumeText = await pfdToText(resume)
      const {data} = await api.post('/api/ai/enhance-resume', {title, resumeText}, {headers: {Authorization: token}})
      setTitle('')
      setResume(null)
