    ...
    <div className="space-y-4">
      ...
      <div className="mt-6">
        <textarea
          ...
          placeholder="Write a professional summary that highlights your key strengts and career objectives..."
        />
        <p className="text-xs text-gray-500 max-w-4/5 mx-auto text-center">
        Tip: Keep it concise (3-4 sectences) and focus on your most relevant achivements and skills.
        </p>
      </div>
    </div>
  );
